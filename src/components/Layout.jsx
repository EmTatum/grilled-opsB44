    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#0a0a0a" }}>
      ...
      >
        ...
        <div style={{ padding: "28px 20px 20px" }}>
          <div style={{ height: "1px", background: "linear-gradient(90deg, transparent, #C9A84C, transparent)", marginBottom: "16px" }} />
          <p style={{ fontFamily: "'Cinzel', serif", fontSize: "18px", fontWeight: 700, color: "#C9A84C", letterSpacing: "0.25em", textAlign: "center", textTransform: "uppercase", margin: 0 }}>
            GRILLED OPS
          </p>
          <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "9px", fontWeight: 300, color: "rgba(201,168,76,0.45)", letterSpacing: "0.3em", textAlign: "center", marginTop: "6px", textTransform: "uppercase" }}>
            — Internal Operations —
          </p>
          <div style={{ height: "1px", background: "linear-gradient(90deg, transparent, #C9A84C, transparent)", marginTop: "16px" }} />
        </div>

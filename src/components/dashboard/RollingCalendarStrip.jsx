        ...
        {days.map((day) => {
          ...
          return (
            <button
              ...
              onClick={() => onSelectDay(day.toISOString())}
              style={{
            ...
            >
              <p style={{ margin: 0, fontFamily: "'Raleway', sans-serif", fontSize: "10px", letterSpacing: "0.16em", textTransform: "uppercase", color: isSelected ? "#C9A84C" : "rgba(245,240,232,0.55)" }}>{day.format("ddd")}</p>
              <p style={{ margin: "8px 0 4px", fontFamily: "'Cinzel', serif", fontSize: "24px", color: "#F5F0E8" }}>{day.format("D")}</p>
              <p style={{ margin: 0, fontFamily: "'Raleway', sans-serif", fontSize: "10px", color: "rgba(245,240,232,0.35)", letterSpacing: "0.12em", textTransform: "uppercase" }}>{day.format("MMM")}</p>
